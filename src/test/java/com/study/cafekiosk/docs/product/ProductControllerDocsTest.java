package com.study.cafekiosk.docs.product;
...
import com.study.cafekiosk.docs.RestDocsSupport;
...
public class ProductControllerDocsTest extends RestDocsSupport {
	...
	void createProduct() throws Exception {
		...
		given(productService.createProduct(any(ProductCreateRequest.class))).willReturn(
